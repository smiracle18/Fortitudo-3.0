...
{%>
<script>
var code=<%out.print(i6.getIsland7());%>
var passcode = prompt("ENTER PASSCODE");
console.log(passcode)
if (passcode==code) {
	if(<%out.print((Integer.parseInt(teamobj.getTeamstatus())));%>==6) {
		 alert("correct passcode one more RIDDLE to get the treasure NOW talk to admin ASAP");
			 window.location.href="UpdateTeamStatus"
			}
	else if(<%out.print((Integer.parseInt(teamobj.getTeamstatus())));%><6){
				alert("SOLVE PRIOR CLUES");
				 window.location.href="TeamMap.jsp"
					 }
	else {alert("YOU HAVE ALREADY SOLVED THIS CLUE");
	 window.location.href="TeamMap.jsp"
		}
}
else
